...
cd tmp
sed		-e 's/\"id\"\: \"better_twitter_dev\@zatsunenomokou\.eu\"/\"id\"\: \"better_twitter\@zatsunenomokou\.eu\"/g' \
		-e 's/\"name\"\: \"Better Twitter (Dev)\"/\"name\"\: \"Better Twitter\"/g' \
		-e 's/\"short_name\"\: \"BetterTwitterDev\"/\"short_name\"\: \"BetterTwitter\"/g' \
		-e 's/\"update_url\"\: \".*\",//gi' \
		-e '/^\s*$/d' \
